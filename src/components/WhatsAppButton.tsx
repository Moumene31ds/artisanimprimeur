...
export default function WhatsAppButton() {
  ...
  return (
    <motion.a
      ...
      className={`fixed bottom-[160px] md:bottom-8 right-6 z-[998] w-14 h-14 bg-[#25D366] text-white rounded-2xl flex items-center justify-center shadow-2xl shadow-green-500/40 border border-white/20`}
